...
export default function CampusesPage() {
  ...
  const activeCampus = branches.find((c) => c.id === activeId) ?? branches[0] ?? null
          ...
          >
            ...
            <div className="flex flex-col justify-center rounded-2xl border border-slate-200 bg-white p-6 shadow-sm shadow-black/5 md:p-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-600">
                Contact our {activeCampus.name} campus for inquiries and support.
              </p>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-relaxed text-slate-600">
                      {activeCampus.location?.map((line, index) => (
