      ...
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        >
          <div>
            ...
            <h2
              className={`${revealClass(
                'animate-load'
              )} mt-3 text-2xl font-semibold leading-tight text-[#0D2B6B] sm:text-3xl md:text-4xl`}
          ...
          <div
            className={`${revealClass(
              'animate-load'
            )} space-y-4 text-base leading-relaxed text-slate-600`}
            style={{ '--delay': '360ms' } as CSSProperties}
          >
            <p>
              VTRUST Group of Educational Institutions traces its foundation to
              2021 with a focus on affordable, high-quality management studies
              and skill-based education pathways.
            </p>
...
later grew across Calicut and Mysore with
            ...
            <p>
              We deliver focused management and optometry education through
              structured academics, practical lab work, and industry-linked
              exposure so students graduate with strong professional confidence.
            </p>
          </div>
          ...
          >
            {stats.map(({ icon: Icon, label, value }) => (
              ...
              >
                ...
                <p className="text-xl font-semibold text-[#0D2B6B]">
                  {value}
                </p>
